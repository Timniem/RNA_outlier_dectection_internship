...
class PlotFunctions:
    ...
    def scatter_plot_fraser(data, patient, gene_panel, p_cutoff=0.05, psi_cutoff=0.1):
        ...
        ax.scatter(x=sx_range, y=sy_range, color='red', alpha=.6, s=8, edgecolors='none')
        ax.set_yscale('linear')
        ax.set_ylabel("-log10(p value)", size=8)
        ax.set_xlabel("deltaPsi", size=8)
        ax.set_xbound(lower=-1.1,upper=1.1)
        ax.grid(False)
        ax.set_title('Volcano plot FRASER', size=8)
    ...
    def scatter_plot_outrider(data, patient, gene_panel, p_cutoff=0.05, z_cutoff=4):
        ...
        ax.grid(False)
        ax.set_title('Volcano plot OUTRIDER', size=8)
        ax.spines['top'].set_visible(False)
        ax.spines['right'].set_visible(False)
        ax.spines['bottom'].set_visible(False)
        ax.spines['left'].set_visible(False)
    ...
    def mae_plot(data, patient, gene_panel, p_cutoff=0.05, log2fc_cutoff=5):
        ...
        ax.grid(False)
        ax.set_title('Volcano plot MAE', size=8)
        ax.spines['top'].set_visible(False)
        ax.spines['right'].set_visible(False)
        ax.spines['bottom'].set_visible(False)
        ax.spines['left'].set_visible(False)
