...
#remove featureCount headers 2-6 
...
#Add names from the samplesheet to the dataframe
cts_table <- cts_table[,c("EnsemblID","EntrezID","GeneSymbol", samplesheet$sampleID)]
